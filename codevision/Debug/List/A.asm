...
_0x3:
	...
	.DB  0x80,0x90,0x20,0x83,0xC6
_0x4:
	.DB  0x37,0x38,0x39,0x23,0x34,0x35,0x36,0x2A
	.DB  0x31,0x32,0x33,0x2D,0x63,0x30,0x3D,0x2B
_0x5:
	.DB  0x6C,0x65,0x64
_0x6:
	.DB  0x62,0x75,0x7A,0x7A,0x65,0x72
_0x7:
	.DB  0x72,0x65,0x6C,0x61,0x79
_0x0:
	.DB  0x25,0x73,0x0,0x2A,0x31,0x34,0x23,0x0
	.DB  0x20,0x20,0x74,0x72,0x75,0x65,0x0,0x20
	.DB  0x20,0x77,0x72,0x6F,0x6E,0x67,0x0,0x70
	.DB  0x61,0x73,0x73,0x77,0x6F,0x72,0x64,0x3A
	.DB  0x0,0x3C,0x3D,0x3D,0x0,0x3D,0x3D,0x3E
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0056     password[ps_count-1] = keybord[PIND/16];
	...
	LDI  R31,HIGH(16)
	CALL __DIVW21
	SUBI R30,LOW(-_keybord)
	SBCI R31,HIGH(-_keybord)
	LD   R30,Z
	MOVW R26,R22
	ST   X,R30
; 0000 0057     sprintf(lcd_str,"%s",password);
	LDI  R30,LOW(_lcd_str)
	LDI  R31,HIGH(_lcd_str)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 0058     lcd_puts(lcd_str);
	LDI  R26,LOW(_lcd_str)
	LDI  R27,HIGH(_lcd_str)
	CALL _lcd_puts
; 0000 0059 
